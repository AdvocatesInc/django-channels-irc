...
htmlhelp_basename = 'DjangoChannelsIRCdoc'
...
man_pages = [
    (master_doc, 'djangochannelsirc', 'Django Channels IRC Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DjangoChannelsIRC', 'Django Channels IRC Documentation',
     author, 'DjangoChannelsIRC', 'One line description of project.',
     'Miscellaneous'),
]